...
//                     }
//                 }
//             } else if (animationPhase >= 1) {  // PHASE 1+: Tree Development
//                 // Keep the seedling stem visible, tree grows from its tip
//                 double growthProgress = treeGrowthScale;

//                 // 1. Draw the seedling stem (stays at its Phase 0 final position)
...
//             // Only draw in Phase 0-2, and hide once zoom starts (Phase 4)
//             if (animationPhase <= 2) {
